...
export default class DevelopmentService {
    private setDev = new Set<{[key: string]: string}>();
    private setUI = new Set<{[key: string]: string}>();
    private mapDevelopmentList = new Map<string, object>();

    get getDevs(): Set<{[key: string]: string}> {
        this.setDev
    ...
    get getUIs(): Set<{[key: string]: string}> {
        this.setUI
    ...
    get getDevelopmentList(): Map<string, object> {
