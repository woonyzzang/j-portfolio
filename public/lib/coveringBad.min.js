...
(function($) {
	$.fn.coveringBad = function(options) {
		...
		// Initialization
			...
			$this.css('backgroundImage', 'url('+$this.data('passive')+')');
			$changeable.css('backgroundImage', 'url('+$this.data('active')+')');
			...
			if(settings.direction === "horizontal" ) {
				...
				$changeable.css('borderRight', '1px dashed #888');
			}else if(settings.direction === "vertical" ) {
				$this.height($changeable.height());
				$changeable.height(setY);
				$changeable.css('borderBottom', '1px dashed #fff');
